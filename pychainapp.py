...
# Step 2: Modifies the Existing Block Data Class to Store Record Data
...
# Step 3: Adds Relevant User Inputs to the Streamlit Interface
...
# Step 4: Tests the PyChain Ledger by Storing Records
...
################################################################################
# Step 1:
#Creates a Record Data Class

# Defines a new Python data class named `Record`. We are giving this new class a
...
################################################################################
# Step 2:
# Modifies the Existing Block Data Class to Store Record Data
...
# Adds an input area where you can get a value for `receiver` from the user.
input_receiver = st.text_input("Receiver")


# Adds an input area where you can get a value for `amount` from the user.
